  ...
  return (
    <Layout>
      <div style={{ maxWidth:1100, margin:'0 auto', padding:'72px 24px 60px' }}>
        ...
        <h1 className="font-display fade-up" style={{ fontSize:'clamp(2.2rem,5vw,3.8rem)', color:'var(--txt)' }}>Playground</h1>
        ...
        <div className="fade-up-2" style={{ marginTop:32 }}>
          ...
          <div className="gc" style={{ padding:32, maxWidth:700 }}>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:16 }}>
              <div>
                <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'1.3rem', color:'var(--txt)' }}>Logic Gate Simulator</div>
              ...
              <span style={{ padding:'4px 12px', border:'1px solid rgba(0,255,178,0.4)', borderRadius:100, fontSize:9, color:'var(--acc)', fontFamily:"'JetBrains Mono',monospace", letterSpacing:'.1em' }}>LIVE</span>
            </div>
            <div style={{ width:'100%', height:1, background:'var(--bdr)', marginBottom:18 }} />
            <GateSimulator />
          </div>

          {/* Particle field teaser */}
          <div className="gc" style={{ padding:28, maxWidth:700, marginTop:16, opacity:0.6 }}>
            <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'1.25rem', color:'var(--txt)' }}>Particle Field</div>
