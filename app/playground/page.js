  ...
  return (
    <Layout>
      <div className="page-wrap">
        ...
        <div className="playground-grid fade-up-2">

          <div className="gc" style={{ padding: '24px 20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, gap: 12 }}>
              <div>
                <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: '1.2rem', color: 'var(--txt)' }}>Logic Gate Simulator</div>
          ...
          <div className="gc" style={{ padding: '24px 20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, gap: 12 }}>
              <div>
                <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: '1.2rem', color: 'var(--txt)' }}>Git Command Simulator</div>
                <div style={{ fontSize: 11, color: 'var(--txt2)', fontFamily: "'Space Mono',monospace", marginTop: 3 }}>Practice real Git commands. Complete all 6 challenges.</div>
              </div>
              <span style={{ padding: '4px 10px', border: '1px solid rgba(168,85,247,0.4)', borderRadius: 100, fontSize: 9, color: 'var(--acc2)', fontFamily: "'JetBrains Mono',monospace", letterSpacing: '.1em', flexShrink: 0 }}>INTERACTIVE</span>
            </div>
            <div style={{ width: '100%', height: 1, background: 'var(--bdr)', marginBottom: 18 }} />
            <GitSimulator />
          </div>
