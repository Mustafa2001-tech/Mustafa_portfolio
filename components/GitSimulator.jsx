...
const LESSONS = [
  ...
  },
  {
    ...
    desc: 'Push your current branch to the remote. You are on feature/navbar — push that branch.',
    hint: 'Try: git push origin feature/navbar  (use your current branch name)',
  ...
  return (
    <div style={{ width: '100%', maxWidth: 720 }}>
      ...
      <div onClick={focusInput} style={{
        ...
        {/* Terminal title bar */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 14px', borderBottom: '1px solid #1e1e2a', background: '#0d0d14' }}>
          {['#FF5F57','#FEBC2E','#28C840'].map(c => (
            <div key={c} style={{ width: 10, height: 10, borderRadius: '50%', background: c }} />
          ))}
          <span style={{ marginLeft: 8, fontSize: 11, color: '#555566' }}>git-simulator — bash</span>
        ...
        <div ref={terminalRef} style={{
          ...
          {/* Welcome message */}
          {history.length === 0 && (
            <div style={{ color: '#8A8A9A', marginBottom: 8 }}>
